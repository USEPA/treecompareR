...
biosolids_classified <- readRDS('../data/biosolids_class.rds')# load("C:/Users/pkruse/treecompareR/treecomparer/data/biosolids_class.rda")
```
...
```{r, echo = FALSE, message = FALSE}
usgswater_classified <- readRDS("../data/usgs_class.rds")
```
