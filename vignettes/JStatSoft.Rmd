...
```{r, echo = FALSE, message = FALSE}
usgswater_classified <- readRDS("../data/usgswater_classified.rds")
```
...
display_subtree(data_1 = BIOSOLIDS2021_class, 
                name_1 = 'Biosolids')
display_subtree(data_1 = USGSWATER_class, 
                name_1 = 'USGS Water')
```
...
prune_and_display_subtree(prune_to = BIOSOLIDS2021_class)
prune_and_display_subtree(prune_to = USGSWATER_class)
```
