...
biosolids_classified <- biosolids_class#readRDS('../data/biosolids_class.rds')# load("C:/Users/pkruse/treecompareR/treecomparer/data/biosolids_class.rda")
```
...
```{r, echo = FALSE, message = FALSE}
usgswater_classified <- usgs_class#readRDS("../data/usgs_class.rds")
```
...
pdf(file = './JSS manuscript/label-bars_fig1.pdf',
    width = 16,
    height = 8.27)
fig_1_2[[1]]
dev.off()

pdf(file = './JSS manuscript/label-bars_fig2.pdf',
    width = 16,
    height = 8.27)
fig_1_2[[2]]
dev.off()
...
pdf(file = './JSS manuscript/chemont-tree_fig3.pdf',
    width = 16,
    height = 8.27)
fig_3
dev.off()
...
pdf(file = './JSS manuscript/biosolids-subtree_fig4.pdf',
    width = 16,
    height = 8.27)
fig_4
dev.off()

pdf(file = './JSS manuscript/usgs-water-subtree_fig5.pdf',
    width = 16,
    height = 8.27)
fig_5
dev.off()
...
pdf(file = './JSS manuscript/subtree-overlap_fig6.pdf',
    width = 16,
    height = 8.27)
fig_6
dev.off()
...
pdf(file = './JSS manuscript/biosolids-prune-subtree_fig7.pdf',
    width = 16,
    height = 8.27)
fig_7
dev.off()

pdf(file = './JSS manuscript/usgswater-prune-subtree_fig8.pdf',
    width = 16,
    height = 8.27)
fig_8
dev.off()
...
fig_9_10 <- data_set_subtrees(data_1 = biosolids_classified, 
                  ...
                  name_1 = 'Biosolids', 
                  name_2 = 'USGS water')
pdf(file = './JSS manuscript/biosolids-usgs-shaded-subtree_fig9.pdf',
    width = 16,
    height = 8.27)
fig_9_10[[1]]
dev.off()

pdf(file = './JSS manuscript/usgs-biosolids-shaded-subtree_fig10.pdf',
    width = 16,
    height = 8.27)
fig_9_10[[2]]
dev.off()
...
fig_11 <- leaf_fraction_subtree(data_1 = biosolids_classified, 
                                                 ...
                                                 name_1 = 'Biosolids', 
                                                 name_2 = 'USGS water')
pdf(file = './JSS manuscript/biosolids-leaf-fraction_fig11.pdf',
    width = 16,
    height = 8.27)
fig_11[[1]]
dev.off()
...
fig_12 <- circ_tree_boxplot(biosolids_classified, 
                  ...
                  tippoint_boxplot = TRUE, 
                  layers = c('kingdom', 'superclass'))
pdf(file = './JSS manuscript/biosolids-circ-boxplot_fig12.pdf',
    width = 16,
    height = 8.27)
fig_12
dev.off()
...
fig_13 <- generate_heatmap(tree_object = chemont_tree, 
                                      ...
                                      column_title = 'Biosolids', 
                                      name = 'Jaccard Similarity')
pdf(file = './JSS manuscript/heatmap-biosolids-usgs_fig13.pdf',
    width = 16,
    height = 8.27)
fig_13
dev.off()
...
fig_14_15 <- generate_tree_cluster(tree = chemont_tree, tree_object = chemont_tree, 
                      ...
                      column_cluster = 2, row_name = 'USGS Water', 
                      column_name = 'Biosolids', isolate_subtree = TRUE)
pdf(file = './JSS manuscript/row2-col2-full_fig14.pdf',
    width = 16,
    height = 8.27)
fig_14_15[[1]]
dev.off()

pdf(file = './JSS manuscript/row2-col2-prune_fig15.pdf',
    width = 16,
    height = 8.27)
fig_14_15[[2]]
dev.off()
...
fig_16_17 <- generate_tree_cluster(tree = chemont_tree, tree_object = chemont_tree, 
                      ...
                      column_cluster = 8, row_name = 'USGS Water', 
                      column_name = 'Biosolids', isolate_subtree = TRUE)
pdf(file = './JSS manuscript/row9-col8-full_fig16.pdf',
    width = 16,
    height = 8.27)
fig_16_17[[1]]
dev.off()

pdf(file = './JSS manuscript/row9-col8-prune_fig17.pdf',
    width = 16,
    height = 8.27)
fig_16_17[[2]]
dev.off()
