...
We are interested in studying these two data sets together for a variety of reasons. The presence of chemicals detected in water is important information when determining risk assessment for human and ecological health. Not only does this indicate what chemicals are being contributed to water from human activity, but also what to expect in water used in commercial, industrial, and residential settings. Chemicals detected in biosolids indicate both what are already present in water before being used, and what human activity contributes to water and that persists through the treatment process of waste water. By examining these two sets, we can get a better idea of which chemicals are introduced directly through human activity and use, and which chemicals are already in the background water as well as those that may be successfully removed from the water and captured within the biosolids. 
