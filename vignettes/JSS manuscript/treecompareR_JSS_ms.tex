...
\begin{Schunk}
\begin{Sinput}
R> usgswater_classified[1:5, c('INCHIKEY', 'kingdom', 'superclass', 'class', 'subclass', 'level5')]
\end{Sinput}
\end{Schunk}
%
...
\tiny
\centering
\begin{tabular}{lllllp{1.4cm}}
\hline

INCHIKEY &	kingdom &	superclass & class & subclass & level5\\
\hline
AAEVYOVXGOFMJO-UHFFFAOYSA-N & Organic compounds	& Organoheterocyclic compounds &	Triazines	& 1,3,5-triazines	& Methylthio-s-triazines \\
AAPVQEMYVNZIOO-UHFFFAOYSA-N &	Organic compounds &	Organic acids and derivatives &	Organic sulfuric acids and derivatives &	Sulfuric acid esters &	Sulfuric acid diesters \\
ADWTYURAFSWNSU-UHFFFAOYSA-N	& Organic compounds &	Organoheterocyclic compounds &	Pyridines and derivatives &	Halopyridines	& 2-halopyridines\\
AFCCDDWKHLHPDF-UHFFFAOYSA-M	& Organic compounds	& Organic salts	& Organic metal salts	& Organic alkali metal salts	& NA \\
AFPRJLBZLPBTPZ-UHFFFAOYSA-N	& Organic compounds & Benzenoids	& Naphthalenes &	NA	& NA\\
\hline
