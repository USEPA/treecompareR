...
\begin{Schunk}
\begin{Sinput}
R> usgswater_classified[1:5, c('CASRN', 'kingdom', 'superclass',
+                              'class', 'subclass')]
\end{Sinput}
\end{Schunk}
%
...
\begin{Schunk}
\begin{Sinput}
R> bio_leaf_frac <- leaf_fraction_subtree(data_1 = biosolids_classified,
+                                         data_2 = usgswater_classified,
+                                         name_1 = 'Biosolids',
+                                         name_2 = 'USGS water')
\end{Sinput}
...
\begin{Schunk}
\begin{Sinput}
R> circ_tree_boxplot(data = biosolids_classified,
+                    col = 'AVERAGE_MASS',
+                    title = 'Biosolids',
