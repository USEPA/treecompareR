...
Observe in \@ref(fig:tip-8) that there are 8 tips, labeled t1,..., t8, with the root labelled n1, and two additional internal nodes n2 and n3. The package ggtree allows for a variety of layouts and in this example we used the `layout_circular()` mode.
...
tip2_15 <- tryCatch(
  ...
  error = function(cond){
    message('Error for generating this tree: \n')
