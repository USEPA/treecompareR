...
chemont_jaccard <- generate_similarity_matrix(tree = chemont_tree,
                                              similarity = general_Jaccard_similarity)

chemont_resnik_IC_SVH <- generate_similarity_matrix(tree = chemont_tree,
                                                    similarity = general_Resnik_similarity)

chemont_lin_IC_SVH <- generate_similarity_matrix(tree = chemont_tree,
                                                    similarity = general_Lin_similarity)

chemont_jiangconrath_IC_SVH <- generate_similarity_matrix(tree = chemont_tree,
                                                    similarity = general_JiangConrath_similarity())
```
